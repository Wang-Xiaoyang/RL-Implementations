...
V_target = state_value_network(input=state_length).to(device)
# copy parameters
...
for k in range(K):
    ...
    target_value, advs = compute_advantage(rewards, states, states_, GAMMA, V_target)
